...
## TL;DR
The robot's **physical body** can do work that would otherwise need sensing, computation, or control. Exploiting the body = a route to minimalism: **let the morphology compute.**
...
- _Examples / videos / systems shown in class:_
- _Any formal notion of "the body doing computation":_
